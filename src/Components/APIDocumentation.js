  ...
  let documentation = [
    {
      "method": "GET",
      "route": "/quotes",
      "url": "https://quotesapivsk.herokuapp.com/quotes/",
      "data": [
        {
      ...
      "parameters": [
        {
          "key": "limit",
          "valueType": "Number",
          "description": "Limit is max number of quotes to be accepted. If limit is greater than total quotes available it sends all available and a message."
        },
        {
          "key": "keyword",
          "valueType": "String",
    ...
    },
    {
      ...
      "parameters": [
        ...
        },
        {
          ...
          "description": "Keywords should be words related to quote Current List of keywords is | Motivational | Inspirational | Humor | Philosophy | Hope | Science | Faith | Wisdom | Knowledge | Romance | Death | Life | Spirituality | Religion | Success | God |"
        }
      ]
    },
    {
      "method": "GET",
      "route": "/quotes/random",
      "url": "https://quotesapivsk.herokuapp.com/quotes/random",
      "data": [
        {
    ...
    },
    {
      "method": "GET",
      "route": "/quotes/<id>",
      "url": "https://quotesapivsk.herokuapp.com/quotes/<id>",
      "data": [
        {
          "_id": "6210981b247fe66aa75d295f",
          "id": 5,
    ...
    },
    {
      ...
      "url": "https://quotesapivsk.herokuapp.com/quotes/totalQuotes",
      "data": [{ "totalQuotes": 14 }]
    }
  ];
      ...
      <div className="apidocumentation__documents">
        <div className="apidocumentation__mainurl">
          ...
          <div className="routeCard__route routeCard__container">
            <span className="url">https://quotesapivsk.herokuapp.com/</span>
            <span
              onClick={copyTextToClipboard(
                "https://quotesapivsk.herokuapp.com/"
              )}
              className="gg-copy"
            ></span>
          </div>
